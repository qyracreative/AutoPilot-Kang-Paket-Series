    ...
    try {
      ...
      const prompt = `
        ...
        5. Cinematic Flow:
           ...
           - Scene 2: The Journey (Courier navigating the ${activeEnv.weather} environment).
           - Scene 3: Approaching the Destination (Courier entering ${activeRecipient.location} area).
           - Scene 4: Arrival (Courier stopping the ${activeCourier.vehicle} and preparing to meet the recipient).
           - Scene 5: Encounter (Courier walking towards the recipient or knocking).
           - Scene 6: Interaction (Courier handing over the ${activeRecipient.package} to the recipient).
           - Scene 7: Climax (Recipient opening the ${activeRecipient.package} and showing a ${activeRecipient.reaction} reaction).
           - Scene 8: Resolution (Closure/Ending reflecting the ${activeEnv.atmosphere} atmosphere).
        ...
        7. Consistent Package: The package being delivered must be ${activeRecipient.package}. Its appearance must be described consistently in every visual prompt.
        ...
        RULES FOR SCENES:
        - NARRATIVE ANCHOR: Ensure the "Story Title" reflects the specific ${activeRecipient.package} and ${activeEnv.atmosphere}.
        ...
        COURIER DETAILS:
        - Name: ${activeCourier.name}
        - Type: ${activeCourier.type}
        - Visual: ${activeCourier.visual}
        - Personality: ${activeCourier.personality}
        - Traits: ${activeCourier.traits}
        - Characteristic: ${activeCourier.characteristic}
        - Vibe: ${activeCourier.vibe}
        - Outfit: ${activeCourier.outfit}
        - Vehicle: ${activeCourier.vehicle}
        
        RECIPIENT DETAILS:
        - Name: ${activeRecipient.name}
        - Type: ${activeRecipient.type}
        - Visual: ${activeRecipient.visual}
        - Personality: ${activeRecipient.personality}
        - Traits: ${activeRecipient.traits}
        - Characteristic: ${activeRecipient.characteristic}
        - Vibe: ${activeRecipient.vibe}
        - Outfit: ${activeRecipient.outfit}
        - Location: ${activeRecipient.location}
        - Package: ${activeRecipient.package}
        - Reaction: ${activeRecipient.reaction}
        
        ENVIRONMENT:
        - Weather: ${activeEnv.weather}
        - Atmosphere: ${activeEnv.atmosphere}
        - Tone: ${activeEnv.tone}
      ...
      <header className="border-b border-[#FFFFFF10] bg-[#151619]/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold tracking-tight">Kang Paket-Series</h1>
